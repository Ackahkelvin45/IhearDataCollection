...
def __init__(self, *args, **kwargs):
    ...
    if "region" in self.data:
        ...
        self.fields["community"].queryset = self.instance.region.communities.order_by(
            "name"
        )
    else:
    ...
    if "category" in self.data:
        ...
        self.fields["class_name"].queryset = self.instance.category.classes.order_by(
            "name"
        )
    else:
    ...
    if "class_name" in self.data:
        ...
        self.fields["subclass"].queryset = self.instance.class_name.subclasses.order_by(
            "name"
        )
    else:
